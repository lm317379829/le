...
<table>
  ...
  <tr>
	  <td>流量统计</td>
	  <td><?php system("cat /tmp/net", $retval);?>/ 1.5 TB</td>
		<td>服务器延时</td>
		<td><?php system("cat /tmp/time", $retval);?>ms</td>
	</tr>	
</table>
...
<?php endif; ?>
	<table>
		<tr>
			<td class="w_foot"><a href="http://leen.tk/yaaw">下载控制</a></td>
			<td class="w_foot"><a href="http://leop.tk:8181">返回路由</a></td>
			<td class="w_foot"><a href="http://leen.tk:8989">进入网盘</a></td>
		</tr>
	</table>
